...
`,
  ...
  },
  {
    appId: 40,
    title: "Venn",
    description: "Dual Euclidean layers with boolean logic (OR/AND/XOR/Accnt)",
    color: "Cyan",
    icon: "euclid",
    params: [
      "MIDI Channel",
    ...
    text: `Venn runs two independent Euclidean rhythms and combines them with boolean logic. Jack 0 is the primary logic result; Jack 1 is coupled to the mode (overlap, symmetric difference, or accent). Lengths can differ per layer for polyrhythmic masks. Shift+Button 1 cycles OR → AND → XOR → Accnt; Shift+Button 2 toggles post-logic invert (shadow). Button 2 mutes both outputs. Division, gate length, Prob %, and Vel % live in the Configurator.`,
    channels: [
      {
        jackTitle: "Logic out",
        jackDescription: "Gate + MIDI Note A for the primary boolean result",
        faderTitle: "Pulses A",
        faderDescription: "Number of pulses in Euclidean layer A",
        faderPlusShiftTitle: "Rotation A",
        faderPlusShiftDescription: "Rotate layer A pattern",
        faderPlusFnTitle: "Length A",
        faderPlusFnDescription: "Step length of layer A (2–32)",
        fnTitle: "Third layer hold",
        fnDescription: "Hold for length editing (Third latch layer)",
        fnPlusShiftTitle: "Cycle Logic",
        fnPlusShiftDescription: "OR → AND → XOR → Accnt",
        ledTop: "Layer A pulse / rotation / length (by latch)",
        ledBottom: "Jack 0 pulse / sync / length band",
      },
      {
        ...
        faderPlusShiftDescription: "Rotate layer B pattern",
        faderPlusFnTitle: "Length B",
        faderPlusFnDescription: "Step length of layer B (2–32)",
        fnTitle: "Mute",
        fnDescription: "Mutes both outputs",
        fnPlusShiftTitle: "Invert",
        fnPlusShiftDescription: "Toggle post-logic shadow invert",
        ledTop: "Layer B pulse / rotation / length (by latch)",
        ledBottom: "Jack 1 pulse / sync / length band",
      },
    ],
  },
  {
