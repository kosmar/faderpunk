...
| **Shift + Left Fader** | **Top** = rate-mod depth in **orange**. **Button** = CV-destination color |
    ...
    channels: [
      {
        ...
        faderPlusShiftTitle: "Rate Mod",
        faderPlusShiftDescription:
          "Depth of internal rate wobble (0 = steady; full = faster/slower around base speed).",
        ...
        ledTopPlusShift: "Rate-mod depth (orange)",
      ...
      },
      {
        ...
        ledBottom:
          "Low / negative half of the output (always, even in 0–10 V range)",
        ledBottomPlusShift: "Off",
        ledBottomPlusFn: "Off",
      },
    ],
