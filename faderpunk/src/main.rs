...
/// Version constants generated by build.rs from Cargo.toml
/// (USB_RELEASE_VERSION, FIRMWARE_VERSION)
mod version {
...
use layout::{
    ...
    LAYOUT_MANAGER, LAYOUT_WATCH, RELEASE_SPAWN_DONE, RELEASE_SPAWN_SIGNAL,
};
